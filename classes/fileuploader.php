	...
	class fileuploaderSub {
		...
		public function upload() {
            ...
            if (isset($upload['type']) && !empty($upload['type'])) {
                ...
                //$this->_fileInfo['id'] = frameSub::_()->getTable('files')->insert($data_to_store);
                $res = true;
        ...
        private function createFileName() {
            return utilsSub::getRandStr(). '-'. utilsSub::getRandStr(). '-'. utilsSub::getRandStr(). '-'. utilsSub::getRandStr();
        }
        /**
