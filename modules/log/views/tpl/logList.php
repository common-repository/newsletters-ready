...
// <!--
var toeAllLogData = <?php echo utilsSub::jsonEncode($this->logs)?>;
...
<div id="toeLogTabs">
    <ul>
        <?php foreach($this->logTypes as $type => $tInfo) {?>
            <li><a href="#toeLogs<?php echo $type?>"><?php _e($tInfo['label'])?></a></li>
        <?php }?>
    </ul>
    <?php foreach($this->logTypes as $type => $tInfo) {?>
