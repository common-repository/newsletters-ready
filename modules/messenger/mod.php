<?php
class messengerSub extends moduleSub {
   ...
   /* public function getTabs(){
        $tabs = array();
        $tab = new tabSub(__('Notifications'), $this->getCode());
	...
	public function send($to, $fromName, $fromEmail, $module, $template, $variables) {
		//$this->addContentTypeFilter();
		$template = frameSub::_()->getModule('messenger')->getModel('email_templates')->getTemplate($module, $template);
       ...
       // $result = wp_mail($to, $subject, $message, $headers);
		...
		$result = frameSub::_()->getModule('mail')->send($to, $subject, $message, $fromName, $fromEmail);
